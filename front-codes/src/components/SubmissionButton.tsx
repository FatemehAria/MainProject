...
const SubmissionBtn = ({ text, type }: SubmissionBtnProps) => {
  return (
    <button
      //   className={`${
      ...
      className="bg-[#4866CF] cursor-pointer text-white w-full whitespace-nowrap text-[24px] py-1 rounded-[7px] font-extrabold"
